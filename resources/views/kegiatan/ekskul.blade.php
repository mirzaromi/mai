        ...
        <div class="grid grid-view projects-masonry">
          <div class="row gx-md-8 gy-10 gy-md-13 isotope">
            <div class="project item col-md-6 col-xl-4 product">
              <figure class="lift rounded mb-6"><a href="/assets/single-project.html"> <img src="/assets/assets/img/photos/cs16.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
                  {{-- <div class="post-category text-line mb-3 text-purple">Paskibraka</div> --}}
                  <h2 class="post-title h2">Paskibraka</h2>
                </div>
                <!-- /.post-header -->
              </div>
              <!-- /.project-details -->
            ...
            <div class="project item col-md-6 col-xl-4 workshop">
              <figure class="lift rounded mb-6"><a href="/assets/single-project2.html"> <img src="/assets/assets/img/photos/cs17.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <div class="project item col-md-6 col-xl-4 still-life">
              <figure class="lift rounded mb-6"><a href="/assets/single-project3.html"> <img src="/assets/assets/img/photos/cs18.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <!-- /.project -->
            <div class="project item col-md-6 col-xl-4 product">
              <figure class="lift rounded mb-6"><a href="/assets/single-project2.html"> <img src="/assets/assets/img/photos/cs20.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <!-- /.project -->
            <div class="project item col-md-6 col-xl-4 product">
              <figure class="lift rounded mb-6"><a href="/assets/single-project.html"> <img src="/assets/assets/img/photos/cs19.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <!-- /.project -->
            <div class="project item col-md-6 col-xl-4 workshop">
              <figure class="lift rounded mb-6"><a href="/assets/single-project3.html"> <img src="/assets/assets/img/photos/cs21.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <div class="project item col-md-6 col-xl-4 concept">
              <figure class="lift rounded mb-6"><a href="/assets/single-project2.html"> <img src="/assets/assets/img/photos/cs22.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <div class="project item col-md-6 col-xl-4 concept still-life">
              <figure class="lift rounded mb-6"><a href="/assets/single-project.html"> <img src="/assets/assets/img/photos/cs23.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
            ...
            <!-- /.project -->
            <div class="project item col-md-6 col-xl-4 product">
              <figure class="lift rounded mb-6"><a href="/assets/single-project3.html"> <img src="/assets/assets/img/photos/cs24.jpg" alt="" /></a></figure>
              <div class="project-details d-flex justify-content-center flex-column">
                <div class="post-header">
