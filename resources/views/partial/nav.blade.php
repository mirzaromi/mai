<div class="container flex-lg-row flex-nowrap align-items-center">
    ...
    <div class="navbar-collapse offcanvas-nav">
      <div class="offcanvas-header d-lg-none d-xl-none">
        <a href="/"><img src="/assets/assets/img/photos/mai/logoMAI-2.png" srcset="/assets/assets/img/photos/mai/logoMAI-2.png " alt="" /></a>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Kegiatan</a>
          <ul class="dropdown-menu">
            ...
            <li class="nav-item"><a class="dropdown-item" href="https://galaxy.mai-au.sch.id/">Event Galaxy</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Pendaftaran</a>
          <ul class="dropdown-menu">
            ...
            <li class="nav-item"><a class="dropdown-item" href="https://ppdb.mai-au.sch.id/">Pendaftaran Online</a></li>
          </ul>
        </li>
    ...
    <div class="offcanvas-info text-inverse">
      ...
      <a href="/assets/index.html"><img src="/assets/assets/img/photos/mai/logoMAI-2.png" srcset="/assets/assets/img/photos/mai/logoMAI-2.png " alt="" /></a>
