    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tabel Perizinan Aktif Terbaru</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="/admin/perizinan/view_import">
                    <button type="button" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah
                        Perizinan Siswa Berkelompok</button>
                </a>
