    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Author</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="anggal Post: activate to sort column ascending">Nama
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-success">
                                                        <a href="/admin/author/{{ $d->id }}"
                                                            class="text-white"><i class="far fa-eye"></i></a>
                                                    </button>
                                                    <button type="button" class="btn btn-warning">
                                                        <a href="/admin/author/{{ $d->id }}/edit"
                                                    ...
                                                    <form action="/admin/author/{{ $d->id }}" method="POST"
                                                        class="">
                                                        @method('delete')
                                                        @csrf
