...
@section('container')
    <div class="col-md-8">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/admin/author/{{ $author->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                            placeholder="Input nama" name="nama" value="{{ old('nama', $author->nama) }}" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                            placeholder="Input jabatan" name="jabatan" value="{{ old('jabatan', $author->jabatan) }}" required>
                        @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('des_singkat') is-invalid @enderror" id="editor" rows="3" name="des_singkat"
                            value="" required>{{ old('des_singkat', $author->des_singkat) }}</textarea>
                        @error('des_singkat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('instagram') is-invalid @enderror" id="instagram"
                            ...
                            value="{{ old('instagram', $author->instagram) }}" required>
                        @error('instagram')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('facebook') is-invalid @enderror" id="facebook"
                            ...
                            value="{{ old('facebook', $author->facebook) }}" required>
                        @error('facebook')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('twitter') is-invalid @enderror" id="twitter"
                            ...
                            value="{{ old('twitter', $author->twitter) }}" required>
                        @error('twitter')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
