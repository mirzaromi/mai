...
<head>
    ...
    <title>Admin MAI Amanatul Ummah</title>
</head>

<body class="body" style="background-color: #019892;">
    <div class="login">
        ...
        <form class="form-signin forms" action="/login" method="post">
            @csrf
            <img class="mb-4 d-block mx-auto" src="assets/img/logoMAI.png" alt="" width="72" height="72">
            <h1 class="h3 mb-3 font-weight-normal text-center fs-5">Admin Website <br> MAI Amanatul Ummah</h1>
          ...
          <label>
            ...
            <button class="btn btn-md  btn-block d-block mx-auto w-50 mt-5"
                style="background-color: #329373; color: #F2FFF8;" type="submit">Log in</button>
