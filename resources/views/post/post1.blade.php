          ...
          <div class="col-md-10 col-xl-8 mx-auto">
            <div class="post-header">
              <div class="post-category text-line">
                <a href="#" class="hover" rel="category">Santri</a>
              </div>
              <!-- /.post-category -->
              <h1 class="display-1 mb-4">RESOLUSI JIHAD, HARI SANTRI BERDEDIKASI UNTUK NEGERI</h1>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <div class="blog single mt-n17">
              <div class="card">
                <figure class="card-img-top"><img src="/assets/assets/img/photos/b1.jpg" alt="" /></figure>
                <div class="card-body">
                  <div class="classic-view">
                    <article class="post">
                      <div class="post-content mb-5">
                        <h2 class="h1 mb-4">RESOLUSI JIHAD, HARI SANTRI BERDEDIKASI UNTUK NEGERI</h2>
                        
                        <p>Setiap tanggal 22 Oktober diperingati hari santri nasional, di tahun 2021 ini berbeda dengan tahun-tahun sebelumnya dikarenakan pendemi Covid-19 yang setiap waktu semakin tinggi angka penyebarannya. Tetapi, melalui protokol kesehatan yang ketat dengan tetap memakai masker baik peserta maupun petugas upacara, hal ini tidak mengurangi semangat para santri melaksanakan upacara dengan tertib dan khidmat. Pondok Pesantren Amanatul Ummah tetap melaksanakan upacara dengan serangkaian kegiatan lainnya untuk memperingati Hari Santri Nasional 2021 ini. </p>
                  ...
                  <div class="author-info d-md-flex align-items-center mb-3">
                    <div class="d-flex align-items-center">
                      <figure class="user-avatar"><img class="rounded-circle" alt="" src="/assets/assets/img/avatars/u5.jpg" /></figure>
                      <div>
                  ...
                  <div class="carousel owl-carousel blog grid-view mb-16" data-margin="30" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "2"}, "1200":{"items": "2"}}'>
                    <div class="item">
                      <article>
                        <figure class="overlay overlay1 hover-scale rounded mb-5"><a href="#"> <img src="/assets/assets/img/photos/b4.jpg" alt="" /></a>
                          <figcaption>
                        ...
                        <div class="post-header">
                          ...
                          <!-- /.post-category -->
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="/assets/blog-post.html">Ligula tristique quis risus</a></h2>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="item">
                      <article>
                        <figure class="overlay overlay1 hover-scale rounded mb-5"><a href="#"> <img src="/assets/assets/img/photos/b5.jpg" alt="" /></a>
                          <figcaption>
                            <h5 class="from-top mb-0">Read More</h5>
                          </figcaption>
                        </figure>
                        <div class="post-header">
                          ...
                          <!-- /.post-category -->
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="/assets/blog-post.html">Nullam id dolor elit id nibh</a></h2>
                        </div>
                        <!-- /.post-header -->
                        <div class="post-footer">
                          <ul class="post-meta mb-0">
                    ...
                    <div class="item">
                      <article>
                        <figure class="overlay overlay1 hover-scale rounded mb-5"><a href="#"> <img src="/assets/assets/img/photos/b6.jpg" alt="" /></a>
                          <figcaption>
                            <h5 class="from-top mb-0">Read More</h5>
                          </figcaption>
                        </figure>
                        <div class="post-header">
                          ...
                          <!-- /.post-category -->
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="/assets/blog-post.html">Ultricies fusce porta elit</a></h2>
                        </div>
                        <!-- /.post-header -->
                        <div class="post-footer">
                          <ul class="post-meta mb-0">
                    ...
                    <div class="item">
                      <article>
                        <figure class="overlay overlay1 hover-scale rounded mb-5"><a href="#"> <img src="/assets/assets/img/photos/b7.jpg" alt="" /></a>
                          <figcaption>
                            <h5 class="from-top mb-0">Read More</h5>
                          </figcaption>
                        </figure>
                        <div class="post-header">
                          ...
                          <!-- /.post-category -->
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="/assets/blog-post.html">Morbi leo risus porta eget</a></h2>
                        </div>
                        <div class="post-footer">
                          <ul class="post-meta mb-0">
