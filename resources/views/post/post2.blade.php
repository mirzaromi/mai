                ...
                <div class="row">
                    <div class="col-md-10 col-xl-8 mx-auto">
                        <div class="post-header">
                            ...
                            <!-- /.post-category -->
                            <h1 class="display-1 mb-4">Susana Ramadhan, Pondok Pesantren Amanatul Ummah</h1>
                            <ul class="post-meta mb-5">
                                <li class="post-date"><i class="uil uil-calendar-alt"></i><span>5 Jul 2021</span>
                                </li>
                                    ...
                                    <div class="classic-view">
                                        <article class="post">
                                            <div class="post-content mb-5">
                                                <h2 class="h1 mb-4">Susana Ramadhan, Pondok Pesantren Amanatul
                                                    Ummah</h2>
                                    ...
                                    <div class="author-info d-md-flex align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <figure class="user-avatar"><img class="rounded-circle" alt=""
                                                    src="/assets/assets/img/avatars/u5.jpg" /></figure>
                                            <div>
